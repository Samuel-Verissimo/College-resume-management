        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Cadastre um novo departamento</h1>
        ...
        <br>
            ...
            <div class="container">
                ...
                <div class="table-responsive col-md-6">
                    <form method="post" action="crud/insert/departamento.php">
                    <p>
                        <div class="form-group">
                            <label>Nome do departamento</label>
                            <input type="text" name="nome" class="form-control" placeholder="Digite o nome do departamento" required>
                        </div>
                    </p>
                    <p>
                ...
                <div class="table-responsive col-md-6">
                    ...
                    <tbody>
                        <?php 
                            ...
                            $query = $conn->prepare("SELECT * FROM aux_departments ORDER BY idDepartment");
                            $query->execute(array());
                        ...
                        ?>
                            ...
                            <tr>
                                <td><?=$row['idDepartment']?></td>
                                <td><?=$row['name']?></td>
                                <td>
                                    <a href="editar_departamentos.php?id=<?=$row['idDepartment']?>"  class="btn"><i class="fa fa-edit"></i> Editar</a>
                                    <a href="crud/delete/departamento.php?id=<?=$row['idDepartment']?>" onclick="return confirm('Você tem certeza que deseja excluir?');" class="btn"><i class="fa fa-trash"></i> Excluir</a>
                                </td>
                            </tr>
